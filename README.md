...
It scans every child address derived from your P84 or P86 extended public key (xpub) and outputs a `results.json` of your Ordinals and Runes holdings across up to 200 addresses—all in one place.
...
## What’s not here
(Not included, but used in development)
